...
import { FiHome, FiCompass, FiMenu, FiUsers, FiLogOut } from 'react-icons/fi';
...
const LinkItems: Array<LinkItemProps> = [
  ...
  { name: 'User List', href: '/admin/user-list', icon: FiUsers },
...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const routeDef = async (link: string | undefined) => {
    router.push(`${link}`);
  };
  return (
    <Box
